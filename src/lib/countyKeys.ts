/** Keep in sync with server/lib/countyElection.mjs */
const TEXAS_COUNTIES = [
  ...
  "Tom Green", "Travis", "Trinity", "Tyler", "Upshur", "Upton", "Uvalde", "Val Verde", "Van Zandt", "Victoria", "Walker",
  "Waller", "Ward", "Washington", "Webb", "Wharton", "Wheeler", "Wichita", "Wilbarger", "Willacy", "Williamson", "Wilson",
...
export function canonicalCountyKey(rawName: string) {
